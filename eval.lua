...
cmd:option('-model','./checkpoint/rnn_every_step_ft.t7','path to model to evaluate')
-- Basic options
cmd:option('-batch_size', 16, 'if > 0 then overrule, otherwise load from checkpoint.')
cmd:option('-num_images', 4900, 'how many images to use when periodically evaluating the loss? (-1 = all)')
