...
local a = utils.read_json('./checkpoint/map512_rnn.json')
a = a.val_lang_stats_history
local b = utils.read_json('./checkpoint/map_rnn_l.json')
b = b.val_lang_stats_history
-------------------------------------------------------------------------------
...
cmd:option('-id', 'map_lstm_l', 'an id identifying this run/job. used in cross-val and appended when writing progress files')
